...
public class Swap {
			...
			if(pokemon1.getTrainer() == trainer1 && pokemon2.getTrainer() == trainer2){
				if(pokemon1.isSwapAllow() && pokemon2.isSwapAllow()){
					if(pokemon1.getType() != pokemon2.getType()){
						...
						pokemon1.getSwaps().add(this);
						pokemon2.getSwaps().add(this);
					...
					System.out.println(pokemon2.isSwapAllow());
					throw new Exception("Pokemon " + pokemon2.getName() + " ist nicht zum Tauschen freigegeben.");
				} else{
	...
	public static void main(String[] args) {
		...
		// should work fine
		System.out.println("This should work fine: pokemon 1 and pokemon 2 are being swaped.");
		try{
		...
		System.out.println("This should print an error: pokemon 1 is not allowed to swap.");
		try{
		...
		System.out.println("This should print an error: pokemon 1 is allowed to swap but pokemon 2 is set to the same type as pokemon 1.");
		try{
